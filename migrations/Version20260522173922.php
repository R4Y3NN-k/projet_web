 ...
 */
final class Version20260522173922 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE command (id INT AUTO_INCREMENT NOT NULL, price NUMERIC(7, 2) NOT NULL, description LONGTEXT NOT NULL, status VARCHAR(255) NOT NULL, created_at DATE NOT NULL, client_id INT NOT NULL, provider_id INT DEFAULT NULL, INDEX IDX_8ECAEAD419EB6921 (client_id), INDEX IDX_8ECAEAD4A53A8AA (provider_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
